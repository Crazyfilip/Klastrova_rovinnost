...
Provedeme následující posloupnost minorových operací. Vezměmě libovolný klastr $K$. Klastry jež jsou s ním v konfliktu ($K_1$ a $K_2)$, můžeme sjednodit (ubyl jeden klastr). Sjednocený klastr označme $K_S$
